...
<div class="wrap">
    <h1>Yoti Settings</h1>
    <p>You need to first create a Yoti App at <a href="<?php esc_attr_e(YotiHelper::YOTI_HUB_URL); ?>" target="_blank">Yoti Hub</a>.</p>
      ...
      <table class="form-table">
          ...
          <tr>
              ...
              <td>
                ...
                <p><code>Yoti Scenario ID</code> identifies the attributes associated with your Yoti application. This value can be found on your application page in Yoti Hub.</p>
              </td>
          </tr>
          <tr>
              ...
              <td>
                  ...
                  <p><code>Yoti Client SDK ID</code> identifies your Yoti Hub application. This value can be found in the Hub, within your application section, in the keys tab.</p>
              </td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td>
                ...
                <input name="yoti_pem" type="file" id="yoti_pem" />
                  <p><code>Yoti PEM File</code> is the application pem file. It can be downloaded only once from the Keys tab in your Yoti Hub.</p>
              </td>
          </tr>
          <tr>
            <th scope="row"></th>
          ...
          <tr>
              ...
              <td>
                  ...
                  <p>(Requires Age verify condition to be set in the <a href="<?php esc_attr_e(YotiHelper::YOTI_HUB_URL); ?>" target="_blank">Yoti Hub</a>)</p>
              </td>
          </tr>
          </tbody>
      </table>
